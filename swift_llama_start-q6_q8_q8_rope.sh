...
exec "$BIN" \
  ...
  --rope-scaling yarn --rope-scale 1.2 --override-kv qwen35.context_length=int:314572  --override-kv qwen35.rope.scaling.original_context_length=int:262144
