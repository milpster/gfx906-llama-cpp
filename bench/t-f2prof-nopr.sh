...
GPU_SINGLE_ALLOC_PERCENT=100 HSA_ENABLE_SDMA=1 GGML_CUDA_DISABLE_GRAPHS=1 HIP_LAUNCH_BLOCKING=1 GGML_F2_PROF=1 \
HSA_DISABLE_FRAGMENT_ALLOCATOR=0 GPU_MAX_ALLOC_PERCENT=100 USE_MLOCK=true \
LD_LIBRARY_PATH=/home/srcds/rocm-gfx906-xnack/lib:/tmp/wt-sync/build-nopr-prof/bin:/opt/rocm-6.1.0/lib \
exec /tmp/wt-sync/build-nopr-prof/bin/llama-server \
