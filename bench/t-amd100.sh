...
LD_LIBRARY_PATH=/home/srcds/rocm-gfx906-xnack/lib:build-vega20-eaman/bin:/opt/rocm-6.1.0/lib \
exec build-vega20-eaman/bin/llama-server \
  ...
  -b 8192 -ub 384 --ctx-checkpoints 30 \
  --temp 0.6 --top-p 0.95 --top-k 20 --min-p 0.0 \
  --presence_penalty 0.0 --repeat-penalty 1.0 \
  --device rocm0,rocm1 --port "$PORT" -np 1 -mg 0 \
