...
VEGA_FATTN_COLS16=$(on_off "${VEGA_TUNE_FATTN_COLS16:-0}")
VEGA_FATTN_OCC3=$(on_off "${VEGA_TUNE_FATTN_OCC3:-0}")
...
VEGA_TOPK_MOE_FUSION=$(on_off "${VEGA_TUNE_TOPK_MOE_FUSION:-0}")
...
cmake -B "$BUILD_DIR" -S "$SCRIPT_DIR" \
    ...
    -DGGML_CUDA_VEGA_TUNE_FATTN_COLS16="$VEGA_FATTN_COLS16" \
    -DGGML_CUDA_VEGA_TUNE_FATTN_OCC3="$VEGA_FATTN_OCC3" \
    ...
    -DGGML_CUDA_VEGA_TUNE_TOPK_MOE_FUSION="$VEGA_TOPK_MOE_FUSION" \
...
grep -E "^GGML_CUDA_VEGA_TUNE(_FATTN|_FATTN_QPIPE|_FATTN_COLS16|_FATTN_OCC3|_MMQ|_MMQ_DUALACC|_MMQ_Q8LDR|_TOPK|_TOPK_MOE_FUSION|_GRAPHS)?:BOOL|^CMAKE_HIP_FLAGS:STRING" \
